...
ORDBOG = [
    ...
    ("Ersatzpapierhalter", "reserverulleholder"),
    ("Föhnhalter", "hårtørrerholder"),
    ("Glätteisenhalter", "glattejernsholder"),
    ("Abfalleimer", "affaldsspand"),
    ("Kosmetikspiegel", "makeupspejl"),
    ("Rasierer", "barbermaskine"),
    ("Öffnung", "åbning"),
    ("möglich", "mulig"),
    ("Montage", "montering"),
